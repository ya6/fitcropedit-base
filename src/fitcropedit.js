...
import ToolsItems from "./layout/ToolsItems";
...
function bootstrap(params) {
  ...
  //
  const toolsItems = new ToolsItems();
  ...
  const controls = new Controls(stateService, imageLoader, mainCanvas, originImage, uiControls, toolsItems);
}
