export default class Appbar {
  ...
  <div class="fc-custom-icon fc-ms-05 fc-avoid-clicks" data-role="custom-toggle-icon-open">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down" viewBox="0 0 16 16">
      <path d="M3.204 5h9.592L8 10.481zm-.753.659 4.796 5.48a1 1 0 0 0 1.506 0l4.796-5.48c.566-.647.106-1.659-.753-1.659H3.204a1 1 0 0 0-.753 1.659"/>
    </svg>
  </div>   
  
  <div class="hidden fc-custom-icon fc-ms-05 fc-avoid-clicks" data-role="custom-toggle-icon-close">
  ...
  <div class="dropdown-box absolute hidden" data-role="dropdown-box">
    <ul class="fc-appbar-ul">
      ...
      <li class="items-link"><span class="item-link-text" data-role="dropdown-item" data-action="save-image" data-active="requires-image">Save</span></li>
