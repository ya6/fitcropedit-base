export default class CloseIconButton {
  template() {
    return `
<div class="standalone-custom-icon position-top-right color-gray cursor-pointer" data-action="close-tool-button">
	<svg class="fc-avoid-clicks" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" viewBox="0 0 21.33 21.33">
