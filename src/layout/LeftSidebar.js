export default class LeftSidebar {
  ...
  innerTemplate() {
    const cropButton = `
    <button class="fc-left-sidebar-button" type="button" data-anchor="left-sidebar-item" data-active="not-implemented">
  ...
  `;
    ...
    const resizeButton = `
  <button class="fc-left-sidebar-button" type="button" data-anchor="left-sidebar-item" data-role="leftsidebar-button"
   data-action="resize" data-active="requires-image">
    <div class="fc-custom-icon mx-auto">	
  ...
  <button class="fc-left-sidebar-button" type="button" data-anchor="left-sidebar-item"
   data-role="leftsidebar-button" data-action="hand" data-active="requires-image">
    <div class="fc-custom-icon mx-auto">
  ...
  <button class="fc-left-sidebar-button" type="button" data-anchor="left-sidebar-item"
  data-role="leftsidebar-button" data-options="has-submenu" data-action="background" data-active="not-implemented">
    <div class="fc-custom-icon mx-auto">         
