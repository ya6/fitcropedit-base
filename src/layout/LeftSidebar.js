export default class LeftSidebar {
  ...
  innerTemplate() {
    const cropButton = `
    <button class="fc-left-sidebar-button" type="button" id="cropButton">
  ...
  <button class="fc-left-sidebar-button" type="button" id="resolutionButton">
    <div class="custom-icon mx-auto">	
  ...
  `;
    ...
    const filtersButton = `
    <button class="fc-left-sidebar-button" type="button" id="filtersButton">
      <div class="custom-icon mx-auto">
  ...
  `;
    ...
    const zoomButton = `
  <button class="fc-left-sidebar-button" type="button" id="zoomButton">
    <div class="custom-icon mx-auto">
  ...
  `;
    ...
    const handButton = `
  <button class="fc-left-sidebar-button" type="button" id="handButton">
    <div class="custom-icon mx-auto">
  ...
  <button class="fc-left-sidebar-button" type="button" id="transformButton">
    <div class="custom-icon mx-auto">
