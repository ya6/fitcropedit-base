export default class LeftSidebar {
  ...
  innerTemplate() {
    const cropButton = `
    <button class="fc-left-sidebar-button" type="button" data-role="crop-button">
  ...
  <button class="fc-left-sidebar-button" type="button" data-role="resolution-button">
    <div class="custom-icon mx-auto">	
  ...
  `;
    ...
    const filtersButton = `
    <button class="fc-left-sidebar-button" type="button" data-role="filter-button">
      <div class="custom-icon mx-auto">
  ...
  `;
    ...
    const zoomButton = `
  <button class="fc-left-sidebar-button" type="button" data-role="zoom-button">
    <div class="custom-icon mx-auto">
  ...
  `;
    ...
    const handButton = `
  <button class="fc-left-sidebar-button" type="button"  data-role="hand-button">
    <div class="custom-icon mx-auto">
  ...
  <button class="fc-left-sidebar-button" type="button"  data-role="transform-button">
    <div class="custom-icon mx-auto">
